//Step 6 - story.dartファイルをインストールする.
import 'story.dart';

//Step 5 - StoryBrainクラスを作る.
class StoryBrain {
//Step 7 - story.dartのクラスでカプセル化を行うための変更を行う.
  ...
  List<Story> _storyData = [
    ...
    Story(
        ...
        choice2: 'Wait,17 I know how to change a tire.'),
    Story(
        storyTitle:
...
//Step 8 - _storyDataから最初のstoryTitleを返すgetStory()メソッドを作成.
  String getStory() {
    return _storyData[0].storyTitle;
  }

// Step 11 - 最初のchoice1のテキストを返すgetChoice1()メソッドを作成する.
  String getChoice1() {
    return _storyData[0].choice1;
  }

//Step 12 - 最初のchoice2のテキストを返すgetChoice2()メソッドを作成する.
  String getChoice2() {
